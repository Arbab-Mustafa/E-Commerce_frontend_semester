    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className="mt-20">
        ...
        <div className="flex flex-col gap-4 border px-6 py-6 text-sm text-gray-500">
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Tempore quo totam molestias sed dolorum ut, impedit est necessitatibus vero quae culpa possimus odit? Molestias provident ut autem error consequatur magnam sapiente, saepe vel quae sint et reiciendis quis dolor nemo temporibus fuga illo reprehenderit veniam ex</p>
          <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Nulla vel perspiciatis provident ratione commodi alias est aspernatur magni mollitia dignissimos.</p>
        </div>
      </div>
